...
model.add(Dense(512, activation='tanh'))  # 2nd Hidden layer with 512 nodes but activation function is tanh
model.add(Dense(512, activation='relu'))  # 3rd Hidden layer with 512 nodes
...
# The model accuracy after tenth epoch on validation data is 98% and loss is 0.1068 which is very similar to previous model
